...
LOCAL_CFLAGS += -O3 -DHAVE_LIBMAD -DMUSIC_SUPPORT -DGNU_SOURCE=1 -DINLINE=inline -DHAVE_INTTYPES_H -DHAVE_MEMORY_H -DLSB_FIRST -D__LIBRETRO__ -DFPM_DEFAULT -DSIZEOF_INT=4 -DSIZEOF_LONG=4 -DSIZEOF_LONG_LONG=8 -DFRONTEND_SUPPORTS_RGB565
