...
void A_BeakAttackPL1(mobj_t *actor);
void A_BeakAttackPL2(mobj_t *actor);
void A_BeakRaise(mobj_t *actor);
void A_BeakReady(mobj_t *actor);
...
void A_FireBlasterPL1(mobj_t *actor);
void A_FireBlasterPL2(mobj_t *actor);
void A_FireCrossbowPL1(mobj_t *actor);
void A_FireCrossbowPL2(mobj_t *actor);
void A_FireGoldWandPL1(mobj_t *actor);
void A_FireGoldWandPL2(mobj_t *actor);
void A_FireMacePL1(mobj_t *actor);
void A_FireMacePL2(mobj_t *actor);
void A_FirePhoenixPL1(mobj_t *actor);
void A_FirePhoenixPL2(mobj_t *actor);
void A_FireSkullRodPL1(mobj_t *actor);
void A_FireSkullRodPL2(mobj_t *actor);
void A_FlameEnd(mobj_t *actor);
void A_FlameSnd(mobj_t *actor);
void A_FloatPuff(mobj_t *actor);
void A_FreeTargMobj(mobj_t *actor);
void A_GauntletAttack(mobj_t *actor);
...
void A_InitPhoenixPL2(mobj_t *actor);
...
void A_ShutdownPhoenixPL2(mobj_t *actor);
...
void A_StaffAttackPL1(mobj_t *actor);
void A_StaffAttackPL2(mobj_t *actor);
