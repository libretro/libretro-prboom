...
typedef enum
{
  ...
  /* --- Heretic sprites (separate 0-based index space; indexes
   * heretic_sprnames[]).  Matches dsda numbering. --- */
  HERETIC_SPR_IMPX = 0,
  HERETIC_SPR_ACLO,
  HERETIC_SPR_PTN1,
  HERETIC_SPR_SHLD,
  ...
  /* --- Hexen sprites (separate 0-based index space; indexes
   * hexen_sprnames[]).  Matches dsda numbering. --- */
  HEXEN_SPR_MAN1 = 0,
  HEXEN_SPR_ACLO,
  HEXEN_SPR_TLGL,
  HEXEN_SPR_FBL1,
...
typedef enum
{
  ...
  /* --- Heretic states (separate 0-based index space within statenum_t;
   * indexes heretic_states[]).  Matches dsda numbering. --- */
  HERETIC_S_NULL = 0,
  ...
  /* --- Hexen states (separate 0-based index space; indexes
   * hexen_states[]).  Matches dsda numbering. --- */
  HEXEN_S_NULL = 0,
...
typedef enum {
  ...
  /* --- Heretic mobjtypes (appended; values continue after Doom's
   * NUMMOBJTYPES so Doom ordinals are unchanged).  Matches dsda-doom's
   * unified mobjtype_t numbering, which the Heretic data tables and
   * codepointers are written against. --- */
  HERETIC_MT_ZERO = NUMMOBJTYPES,
  ...
  /* --- Hexen mobjtypes (extend after Heretic; HEXEN_MT_ZERO marks the
   * base so hexen_mobjinfo[] is indexed as [type - HEXEN_MT_ZERO],
   * mirroring the Heretic slice).  Matches dsda numbering. --- */
  HEXEN_MT_ZERO = HERETIC_NUMMOBJTYPES,
