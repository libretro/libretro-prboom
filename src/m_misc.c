...
default_t defaults[] =
{
  ...
  {"uncapped_framerate", {&movement_smooth},  {1},0,3,
   def_int,ss_stat},
...
// CPhipps - now they're the doom codes, so default.cfg can be portable
  ...
  {"key_weaponcycleup",{&key_weaponcycleup},     {'m'}         ,
	  0,MAX_KEY,def_key,ss_keys}, // key to switch to the next weapon
  {"key_weaponcycledown",{&key_weaponcycledown}, {'n'}         ,
	  0,MAX_KEY,def_key,ss_keys}, // key to switch to the previous weapon
