...
void A_KoraxChase(mobj_t *);
void A_KoraxStep(mobj_t *);
void A_KoraxStep2(mobj_t *);
void A_KoraxBonePop(mobj_t *);
void A_KoraxDecide(mobj_t *);
void A_KoraxMissile(mobj_t *);
void A_KoraxCommand(mobj_t *);
void A_KSpiritWeave(mobj_t *);
void A_KSpiritRoam(mobj_t *);
void A_KBolt(mobj_t *);
void A_KBoltRaise(mobj_t *);
dbool P_UpdateMorphedMonster(mobj_t *, int);
void A_PigLook(mobj_t *);
void A_PigChase(mobj_t *);
void A_PigAttack(mobj_t *);
void A_PigPain(mobj_t *);
void A_DragonInitFlight(mobj_t *);
void A_DragonFlight(mobj_t *);
void A_DragonFlap(mobj_t *);
void A_DragonAttack(mobj_t *);
void A_DragonFX2(mobj_t *);
void A_DragonPain(mobj_t *);
void A_DragonCheckCrash(mobj_t *);
void A_FastChase(mobj_t *);
void A_FighterAttack(mobj_t *);
void A_ClericAttack(mobj_t *);
void A_MageAttack(mobj_t *);
void A_ClassBossHealth(mobj_t *);
